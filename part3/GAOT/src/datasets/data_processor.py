...
class DataProcessor:
    ...
    def create_data_loaders(self, data_splits: Dict, is_variable_coords: bool,
                            encoder_graphs: Optional[dict] = None,
                            decoder_graphs: Optional[dict] = None,
        ...
        for split in ['train', 'val', 'test']:
            ...
            if is_variable_coords:
                ...
                latent_queries_split = latent_queries_per_split[split] if latent_queries_per_split else None
                ...
                dataset = CustomDataset(
                    c_data, u_data, x_data,
                    encoder_graphs_split, decoder_graphs_split,
                    latent_queries_split=latent_queries_split,
                    transform=self.coord_scaler  
                )
